...
function nameTest() {
    ...
    for (let i = 0; i < hobbyList.length; i++) {
        ...
        // input 요소.checked -> 요소가 체크되어 있으면 true, 아님 false 반환
        // input 요소.checked = true -> 해당요소를 체크
        // input 요소.checked = false -> 해당요소를 체크 해제
...
function cssTest() {
    /*
        ...
        [요소 n개 - > 배열]
        1) document.querySelectorAll("CSS 선택자");
    ...
    */
    ...
    const x = document.querySelector('[target-div="css-div"] > div');
    x.innerText = "CSS 선택자로 선택해서 값 변경됨";

    // 두번째 자식 div
    const y = document.querySelector('[target-div="css-div"] > div:last-child');
    y.innerText = "첫번째 요소가 아니면 querySelector() 특징 활용 못함";
